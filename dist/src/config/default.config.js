...
class DefaultConfig {
    ...
    static get settings() {
        return {
            ...
            paymentsURL: this._settings.paymentsURL ? this._settings.paymentsURL : globals_1.Globals.GET_PAYMENT_URL(),
            contractURL: this._settings.contractURL ? this._settings.contractURL : globals_1.Globals.GET_CONTRACT_URL(),
