...
class DefaultConfig {
    ...
    static get settings() {
        return {
            ...
            pullPaymentModelURL: this._settings.pullPaymentModelURL ? this._settings.pullPaymentModelURL : globals_1.Globals.GET_PULL_PAYMENT_MODEL_URL(),
            pullPaymentURL: this._settings.pullPaymentURL ? this._settings.pullPaymentURL : globals_1.Globals.GET_PAYMENT_URL(),
            ...
            redisClient: this._settings.redisClient ? this._settings.redisClient : globals_1.Globals.GET_DEFAULT_REDIS_CLIENT(),
