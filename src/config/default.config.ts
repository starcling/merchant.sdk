...
export class DefaultConfig {
    ...
    public static get settings() {
        return {
            ...
            pgUser: this._settings.pgUser ? this._settings.pgUser : Globals.GET_PG_USER(),
            pgHost: this._settings.pgHost ? this._settings.pgHost : Globals.GET_PG_HOST(),
            pgDatabase: this._settings.pgDatabase ? this._settings.pgDatabase : Globals.GET_PG_DATABASE(),
            pgPassword: this._settings.pgPassword ? this._settings.pgPassword : Globals.GET_PG_PASSWORD(),
            pgPort: this._settings.pgPort ? this._settings.pgPort : Globals.GET_PG_PORT(),
