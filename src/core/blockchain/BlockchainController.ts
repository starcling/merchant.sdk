...
export class BlockchainController {
    ...
    */
    public async executePullPayment(contractID?: string): Promise<void> {
        ...
        const serializedTx: string = await new RawTransactionSerializer(data, paymentContract.pullPaymentAddress, txCount).getSerializedTx();
        ...
        await blockchainHelper.executeSignedTransaction(serializedTx).on('transactionHash', async (hash) => {
            ...
            // contractDbController.updatePayment(<IPaymentUpdateDetails>{
